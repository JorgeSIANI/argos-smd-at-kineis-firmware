 ...
 * @author  Kinéis
 * @brief subset of AT commands concerning satellite PASS predictions, useful for Medium Access
 *
 ...
 *
 * @note This command is actually a stub, used to answer correctly to GUI. There is no functional
